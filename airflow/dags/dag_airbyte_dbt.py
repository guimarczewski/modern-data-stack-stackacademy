...
from airflow.utils.dates import days_ago # para criar agendamentos
from airflow.providers.airbyte.operators.airbyte import AirbyteTriggerSyncOperator # para rodar o airbyte
from airflow.models import Variable
import json

# cada connection tem um connection id diferente: <base_url>/workspaces/<workspace-id>/connections/<connection-id>/status
...
with DAG(dag_id='trigger_airbyte_dbt_job',
    ...
    airbyte_economy_sync = AirbyteTriggerSyncOperator(
        ...
        airbyte_conn_id='airbyte_example', #connection criada no airflow, que está na mesma rede do airbyte
    ...
    #ordem da operação, index por último pois a transformation está sinc com o github model dbt
